...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pointofsales` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `akun` (
  `kdakun` char(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `namaakun` varchar(100) DEFAULT NULL,
  `kdparent` char(7) DEFAULT NULL,
...
CREATE TABLE `barang` (
  ...
  `kdbarang` char(15) DEFAULT NULL,
  `namabarang` varchar(100) DEFAULT NULL,
  `idkategori` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `kdakun` char(9) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `stok` int DEFAULT '0',
  ...
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `idjenisbarang` char(3) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `jenisbonuspenjualan` enum('Nominal','Persen') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Persen',
  `persenbonuspenjualan` decimal(3,2) DEFAULT '0.00',
  `jumlahbonuspenjualan` decimal(18,0) DEFAULT '0',
  `jenisbonustagihan` enum('Nominal','Persen') DEFAULT NULL,
...
CREATE TABLE `bonus` (
  `idbonus` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `tglbonus` date DEFAULT NULL,
  `idsales` char(10) DEFAULT NULL,
...
CREATE TABLE `bonuspenagihan` (
  ...
  `idbonus` char(15) DEFAULT NULL,
  `idpiutang` char(12) DEFAULT NULL,
  `idpenjualan` char(15) DEFAULT NULL,
...
CREATE TABLE `ekspedisi` (
  `idekspedisi` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `namaekspedisi` varchar(50) DEFAULT NULL,
  `alamatekspedisi` varchar(255) DEFAULT NULL,
  `notelpekspedisi` char(20) DEFAULT NULL,
  `emailekspedisi` varchar(50) DEFAULT NULL,
  `nikpemilik` char(16) DEFAULT NULL,
  `namapemilik` varchar(50) DEFAULT NULL,
  `notelppemilik` char(20) DEFAULT NULL,
  `nowapemilik` char(20) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') DEFAULT NULL,
  `kdakunutang` char(9) DEFAULT NULL,
...
CREATE TABLE `hutang` (
  `idhutang` char(12) NOT NULL,
  `idpembelian` char(15) DEFAULT NULL,
  ...
  `jenissumber` enum('Pembelian','Non Pembelian') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Pembelian',
  `keterangan` varchar(255) DEFAULT NULL,
...
CREATE TABLE `hutangdetail` (
  `idhutangdetail` char(15) NOT NULL,
  `idhutang` char(12) DEFAULT NULL,
  `tglhutang` date DEFAULT NULL,
  ...
  `updated_date` datetime DEFAULT NULL,
  `idpengguna` char(10) DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer','Giro') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `jenis` enum('Hutang','Pembayaran Hutang') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `nobilyetgiro` varchar(25) DEFAULT NULL,
...
CREATE TABLE `hutangekspedisi` (
  `idhutangekspedisi` char(15) NOT NULL,
  `idtransaksi` char(15) DEFAULT NULL,
  `tglhutang` date DEFAULT NULL,
  `idekspedisi` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `debet` decimal(18,0) DEFAULT NULL,
  `kredit` decimal(18,0) DEFAULT NULL,
  `jenissumber` enum('Pembelian','Penjualan','Pembayaran','Saldo') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `keterangan` varchar(255) DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer','Giro') DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `jenis` enum('Hutang','Pembayaran') DEFAULT NULL,
  `nobilyetgiro` varchar(25) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
...
CREATE TABLE `jenisekspedisi` (
  `idjenisekspedisi` char(3) NOT NULL,
  `namajenisekspedisi` varchar(50) DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Aktif',
...
CREATE TABLE `jenispiutang` (
  `idjenispiutang` char(3) NOT NULL,
  `namajenispiutang` varchar(50) DEFAULT NULL,
...
CREATE TABLE `jenistransaksi` (
  `idjenistransaksi` char(3) NOT NULL,
  `namajenistransaksi` varchar(50) DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') DEFAULT 'Aktif',
...
CREATE TABLE `jurnal` (
  `idjurnal` char(15) NOT NULL,
  `tgljurnal` date DEFAULT NULL,
  `keterangan` varchar(255) DEFAULT NULL,
  `totaldebet` decimal(18,0) DEFAULT NULL,
  `totalkredit` decimal(18,0) DEFAULT NULL,
  `referensi` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `jenis` enum('Penjualan','Pembelian','Stock Adjustment','Penerimaan','Pengeluaran','Hutang','Piutang','Jurnal Penyesuaian','Retur Pembelian','Retur Penjualan','Saldo Awal') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `idpengguna` char(10) DEFAULT NULL,
  `idposting` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `kategoribarang` (
  `idkategori` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `konsumen` (
  `idkonsumen` char(6) NOT NULL,
  `namakonsumen` varchar(50) DEFAULT NULL,
  `alamatkonsumen` varchar(255) DEFAULT NULL,
  `notelpkonsumen` char(20) DEFAULT NULL,
  `emailkonsumen` varchar(50) DEFAULT NULL,
  `nikpemilik` char(16) DEFAULT NULL,
  `namapemilik` varchar(50) DEFAULT NULL,
  `notelppemilik` char(20) DEFAULT NULL,
  `nowapemilik` char(20) DEFAULT NULL,
  `saldo` decimal(18,0) DEFAULT '0',
  `idwilayah` char(3) DEFAULT NULL,
  ...
  `kdakunpiutang` char(9) DEFAULT NULL,
...
CREATE TABLE `otorisasi` (
  `idotorisasi` char(5) NOT NULL,
  `namaotorisasi` varchar(50) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') DEFAULT 'Aktif',
...
CREATE TABLE `pembelian` (
  `idpembelian` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `idsupplier` char(10) NOT NULL,
  `nofaktur` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `idpengguna` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer','Hutang','Giro') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `nobilyetgiro` varchar(25) DEFAULT NULL,
  ...
  `statuspenerimaan` enum('Belum Diterima','Sudah Diterima') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Belum Diterima',
  `tgl_po` date DEFAULT NULL,
  `keterangan_po` varchar(255) DEFAULT NULL,
  `idpengguna_po` char(10) DEFAULT NULL,
...
CREATE TABLE `pembeliandetail` (
  ...
  `idpembelian` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `jenisdiskon` enum('Persen','Nominal') DEFAULT NULL,
...
CREATE TABLE `penagihan` (
  ...
  `updated_date` datetime DEFAULT NULL,
  `idpengguna` char(10) DEFAULT NULL,
  `statuscetak` enum('Sudah Cetak','Belum Cetak') DEFAULT NULL,
...
CREATE TABLE `penagihandetail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idpenagihan` char(15) DEFAULT NULL,
  `idpiutang` char(12) DEFAULT NULL,
  `jumlahtagihan` decimal(18,0) DEFAULT NULL,
  `idsalesbonus` char(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `penerimaan` (
  ...
  `updated_date` datetime DEFAULT NULL,
  `idpengguna` char(10) DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer') DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
...
CREATE TABLE `penerimaandetail` (
  ...
  `idpenerimaan` char(15) DEFAULT NULL,
  `kdakun` char(9) DEFAULT NULL,
...
CREATE TABLE `pengeluaran` (
  `idpengeluaran` char(15) NOT NULL,
  `tglpengeluaran` date DEFAULT NULL,
  `nokwitansi` varchar(30) DEFAULT NULL,
  `totalpengeluaran` decimal(18,0) DEFAULT NULL,
  `keterangan` varchar(255) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `idpengguna` char(10) DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
...
CREATE TABLE `pengeluarandetail` (
  ...
  `idpengeluaran` char(15) DEFAULT NULL,
  `kdakun` char(9) DEFAULT NULL,
...
CREATE TABLE `pengguna` (
  ...
  `notelppengguna` char(20) DEFAULT NULL,
  `emailpengguna` varchar(50) DEFAULT NULL,
  `fotopengguna` varchar(255) DEFAULT NULL,
  `username` varchar(50) DEFAULT NULL,
  `password` varchar(255) DEFAULT NULL,
  `idotorisasi` char(5) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') DEFAULT 'Aktif',
...
CREATE TABLE `penjualan` (
  `idpenjualan` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `idkonsumen` char(6) DEFAULT NULL,
  `tglinvoice` date DEFAULT NULL,
  `noinvoice` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `keterangan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `totalpenjualan` decimal(18,0) DEFAULT '0',
  `totaldpp` decimal(18,0) DEFAULT '0',
  `totaldiskon` decimal(18,0) DEFAULT '0',
  ...
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `carabayar` enum('Tunai','Transfer','Piutang','Giro') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `idjenispiutang` char(3) DEFAULT NULL,
  `idsales` char(10) DEFAULT NULL,
  `nokwitansi` char(18) DEFAULT NULL,
  `nobilyetgiro` varchar(25) DEFAULT NULL,
...
CREATE TABLE `penjualandetail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `idpenjualan` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbarang` char(10) DEFAULT NULL,
  ...
  `jenisbonuspenjualan` enum('Nominal','Persen') DEFAULT NULL,
  `persenbonuspenjualan` decimal(3,2) DEFAULT '0.00',
  `jumlahbonuspenjualan` decimal(18,0) DEFAULT '0',
  ...
  `idjenisbarang` char(3) DEFAULT NULL,
  `persenbonustarget` decimal(3,2) DEFAULT NULL,
...
CREATE TABLE `piutang` (
  `idpiutang` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `idpenjualan` char(15) DEFAULT NULL,
  `idjenispiutang` char(3) DEFAULT NULL,
  ...
  `jenissumber` enum('Penjualan','Saldo') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'Penjualan',
  `keterangan` varchar(255) DEFAULT NULL,
...
insert  into `piutang`(`idpiutang`,`idpenjualan`,`idjenispiutang`,`tglpiutang`,`tgljatuhtempo`,`idkonsumen`,`totaldebet`,`totalkredit`,`jenissumber`,`keterangan`,`tgllunas`) values ('250522PI0001','250522JL0000001','P03','2025-05-22','2025-05-29','KUE001',11500000,5000000,'Penjualan','Piutang Penjualan dengan No Invoice SJA/2505/000001',NULL),('250527PI0001','250527JL0000001','P03','2025-05-27','2025-06-03','IPJ001',150000,150000,'Penjualan','Piutang Penjualan dengan No Invoice SJA/2505/000002','2025-05-29');
...
CREATE TABLE `piutangdetail` (
  `idpiutangdetail` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `idpiutang` char(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `tglpiutang` date DEFAULT NULL,
  `debet` decimal(18,0) DEFAULT NULL,
  `kredit` decimal(18,0) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  ...
  `carabayar` enum('Tunai','Transfer','Giro') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `jenis` enum('Piutang','Pembayaran Piutang') DEFAULT NULL,
  `nokwitansi` char(18) DEFAULT NULL,
  `nobilyetgiro` varchar(25) DEFAULT NULL,
...
insert  into `piutangdetail`(`idpiutangdetail`,`idpiutang`,`tglpiutang`,`debet`,`kredit`,`inserted_date`,`updated_date`,`idpengguna`,`carabayar`,`idbank`,`jenis`,`nokwitansi`,`nobilyetgiro`,`bonuspenagihansudahdibayar`) values ('250522PI0001001','250522PI0001','2025-05-22',11500000,0,'2025-05-22 07:42:43','2025-05-22 07:42:43','USRBID0001',NULL,NULL,'Piutang',NULL,NULL,0),('250522PI0001002','250522PI0001','2025-05-29',0,5000000,'2025-07-11 09:26:07','2025-07-11 09:26:07','USRBID0001','Tunai',NULL,'Pembayaran Piutang','250522JL0000001#01',NULL,0),('250527PI0001001','250527PI0001','2025-05-27',150000,0,'2025-05-27 13:30:39','2025-05-27 13:30:39','USRBID0001',NULL,NULL,'Piutang',NULL,NULL,0),('250527PI0001002','250527PI0001','2025-05-29',0,150000,'2025-05-29 09:44:29','2025-05-29 09:44:29','USRBID0001','Transfer','BN001','Pembayaran Piutang','250527JL0000001#01',NULL,0);
...
CREATE TABLE `postingjurnal` (
  `idposting` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `returpembelian` (
  `idreturpembelian` char(15) NOT NULL,
  `idpembelian` char(15) NOT NULL,
  ...
  `carabayar` enum('Tunai','Transfer') DEFAULT NULL,
  `idbank` char(5) DEFAULT NULL,
  `statusretur` enum('Proses','Selesai') DEFAULT 'Proses',
...
CREATE TABLE `returpembeliandetail` (
  ...
  `idreturpembelian` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `idbarang` char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `returpenjualan` (
  `idreturpenjualan` char(15) NOT NULL,
  `idpenjualan` char(15) NOT NULL,
  `tglretur` date DEFAULT NULL,
  `totalretur` decimal(18,0) DEFAULT NULL,
  `keterangan` varchar(255) DEFAULT NULL,
...
CREATE TABLE `riwayathutangekspedisi` (
  ...
  `idpengguna` char(10) DEFAULT NULL,
  `namapengguna` varchar(50) DEFAULT NULL,
  `jenistransaksi` enum('Pembelian','Penjualan','Pembayaran') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `riwayatstok` (
  ...
  `idpengguna` char(10) DEFAULT NULL,
  `namapengguna` varchar(50) DEFAULT NULL,
  `jenistransaksi` enum('Pembelian','Penjualan','Retur Pembelian','Retur Penjualan','Stock Opname') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `saldoawal` (
  `idsaldoawal` char(4) NOT NULL,
  `tahun` char(4) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `totaldebet` decimal(18,0) DEFAULT NULL,
  `totalkredit` decimal(18,0) DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
...
CREATE TABLE `saldoawaldetail` (
  `idsaldoawal` char(4) DEFAULT NULL,
  `kdakun` char(9) DEFAULT NULL,
  `debet` decimal(18,0) DEFAULT NULL,
  `kredit` decimal(18,0) DEFAULT NULL,
...
CREATE TABLE `sales` (
  `idsales` char(10) NOT NULL,
  `namasales` varchar(50) DEFAULT NULL,
  `jeniskelamin` enum('Laki-laki','Perempuan') DEFAULT NULL,
  `nik` char(16) DEFAULT NULL,
  `tempatlahir` varchar(50) DEFAULT NULL,
  `tgllahir` date DEFAULT NULL,
  `agama` enum('Islam','Katolik','Kristen Protestan','Hindu','Buddha','Konghucu') DEFAULT NULL,
  `alamatktp` text,
  `alamattinggal` text,
  `statusperkawinan` enum('Kawin','Tidak Kawin','Janda/ Duda') DEFAULT NULL,
  `nowa` char(20) DEFAULT NULL,
  `email` varchar(50) DEFAULT NULL,
  `tglkontrak` date DEFAULT NULL,
  `filekontrak` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `inserted_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') DEFAULT NULL,
  `npwp` char(20) DEFAULT NULL,
...
insert  into `sessions`(`id`,`user_id`,`ip_address`,`user_agent`,`payload`,`last_activity`) values ('f5IeVp5e5Ywd1c5iI3zj5GyMVo67r80kuwfc68qp',NULL,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36','',1752172202);
...
CREATE TABLE `settings` (
  `prefix` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `values` text,
...
CREATE TABLE `stockopname` (
  `idstockopname` char(15) NOT NULL,
...
CREATE TABLE `stockopnamedetail` (
  ...
  `idstockopname` char(15) DEFAULT NULL,
  `idbarang` char(10) DEFAULT NULL,
  `stocksystem` int DEFAULT NULL,
  `stockopname` int DEFAULT NULL,
  `keterangandetail` varchar(255) DEFAULT NULL,
...
CREATE TABLE `supplier` (
  ...
  `kontakperson` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `notelp` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
CREATE TABLE `suratjalan` (
  `idsuratjalan` char(10) NOT NULL,
  `tglsuratjalan` date DEFAULT NULL,
  `idkonsumen` char(6) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  `idpengguna` char(10) DEFAULT NULL,
  `idekspedisi` char(10) DEFAULT NULL,
  `idjenisekspedisi` char(3) DEFAULT NULL,
  `identitasekspedisi` varchar(255) DEFAULT NULL,
...
CREATE TABLE `suratjalandetail` (
  ...
  `idsuratjalan` char(10) DEFAULT NULL,
  `idpenjualan` char(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
