...
use App\Models\Laputangekspedisi;
use Illuminate\Http\Request;
use App\Models\Pengguna;
use App\Models\Supplier;
use TCPDF;

class LaputangekspedisiController extends Controller
{
    var $model;
    var $supplier;
    var $pengguna;
    ...
    {
        $this->model = new Laputangekspedisi;
    ...
    {
        $data['menu'] = 'laputangekspedisi';
        return view('laputangekspedisi.index', $data);
    }
    ...
    public function cetak($jenisCetakan, Request $request)
    {
        ...
        */
        ...
        // dd($idekspedisi);
        // exit();
        $data['rsLaporan'] = $this->model->getLaporan($statusLunasOption, $idekspedisi);
        $view = view('laputangekspedisi.cetak', $data);
