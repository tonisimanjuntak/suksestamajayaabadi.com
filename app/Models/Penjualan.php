            ...
            if (session('stok_penjualan_dari_surat_jalan') != '1') {
                foreach ($dataDetail as $detail) {
                    ...
                    $riwayatstok = array(
                        ...
                        'deskripsi' => 'Tambah data penjualan dengan no invoice ' . $data['noinvoice']. ' untuk konsumen ' . $data['namakonsumen'],
                ...
                */
                ...
                foreach ($detailOld as $rowDetail) {
                    ...
                    $riwayatstok = array(
                        ...
                        'deskripsi' => 'Update data penjualan No Invoice ' . $data['noinvoice']. ' untuk konsumen ' . $data['namakonsumen'],
                        'idpengguna' => session()->get('idpengguna'),
                        'namapengguna' => session()->get('namapengguna'),
                        'jenistransaksi' => 'Penjualan',
                    );
