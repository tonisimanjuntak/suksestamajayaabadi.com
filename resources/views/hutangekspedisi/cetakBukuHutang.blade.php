            ...
            <table border="0" cellpadding="0" width="100%">
                <thead>
                    <tr style="font-size: 9px; font-weight: bold;">
                        ...
                        <th width="38%" style="text-align: left;">{{ $rsHutang->idhutang . '/ '. tgldmy($rsHutang->tglhutang) }}</th>
                        <th width="15%" style="text-align: left;">TOTAL UTANG</th>
                        <th width="5%" style="text-align: center;">:</th>
                        <th width="20%" style="text-align: right;">Rp. {{ format_rupiah($rsHutang->totalkredit) }}
                        </th>
                    </tr>
                    <tr style="font-size: 9px; font-weight: bold;">
                        <th width="20%" style="text-align: left;">NAMA SUPPLIER</th>
                        <th width="2%" style="text-align: center;">:</th>
                        <th width="38%" style="text-align: left;">{{ $rsSupplier->namasupplier }}</th>
                        <th width="15%" style="text-align: left;">SUDAH DIBAYAR</th>
                        <th width="5%" style="text-align: center;">:</th>
                        <th width="20%" style="text-align: right;">Rp. {{ format_rupiah($rsHutang->totaldebet) }}
                        </th>
                    </tr>
                    <tr style="font-size: 9px; font-weight: bold;">
                        ...
                        <th width="20%" style="text-align: right;">Rp.
                            {{ format_rupiah($rsHutang->totalkredit - $rsHutang->totaldebet) }}</th>
                    </tr>
                </thead>
            ...
            <tbody>
                ...
                @else
                    ...
                    <tr style="font-size:9px; font-weight: bold;">
                        ...
                        <td width="25%" style="text-align:right;">{{ format_rupiah($totalKredit - $totalDebet) }}</td>
                    </tr>
