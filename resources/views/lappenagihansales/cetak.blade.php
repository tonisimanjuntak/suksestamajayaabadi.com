...
<body>
    ...
    <div class="judullaporan">
        ...
        <div class="periode-laporan">
            PERIODE {{ Str::upper(tglindonesia($tglawal)) }} S/D {{
            Str::upper(tglindonesia($tglakhir)) }}
            @if (!empty($statuslunas) && $statuslunas != null)
            <br>
            <span>STATUS: {{ Str::upper($statuslunas) }}</span>
            @endif
        </div>
        @else
        <div class="periode-laporan">
            PERIODE {{ Str::upper(tglindonesia($tglawal)) }}
            @if (!empty($statuslunas) && $statuslunas != null)
            <br>
            <span>STATUS: {{ Str::upper($statuslunas) }}</span>
            @endif
