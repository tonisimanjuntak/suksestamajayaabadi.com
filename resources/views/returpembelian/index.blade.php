                            ...
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                        Retur Pembelian</h3>
                                    <a href="{{ url('returpembelian/tambah') }}" class="btn btn-sm btn-primary"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <label for=""
                                                        class="col-md-2 col-form-label text-center">S/D</label>
                                                    <div class="col-md-5">
                                        ...
                                        <table class="table table-bordered text-sm" id="tableList">
                                            <thead class="">
                                                <tr>
                                                    ...
                                                    <th style="width: 10%; text-align: left;">No Faktur/<br>Tanggal</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#tableList').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('returpembelian.listdata') }}",
                    type: 'GET',
                    data: function(d) {
