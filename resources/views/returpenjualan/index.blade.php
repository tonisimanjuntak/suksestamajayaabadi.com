                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Retur Penjualan</h3>
                                <a href="{{ url('returpenjualan/tambah') }}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <table class="table table-bordered text-sm" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="width: 15%; text-align: center;">Tgl Retur<br>Id Retur</th>
                                                <th style="width: 15%; text-align: center;">Tgl Invoice<br>No Invoice</th>
                                                <th style="text-align: left;">Konsumen</th>
                                                <th style="text-align: left;">Keterangan</th>
                                                <th style="text-align: center;">Cara Bayar</th>
                                                <th style="width: 10%; text-align: right;">Total Retur</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tableList').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('returpenjualan.listdata') }}",
                type: 'GET',
                data: function(d) {
