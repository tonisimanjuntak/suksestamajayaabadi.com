            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Buku Utang</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                Buku Utang</h3>
                            <a href="{{ url('hutang/tambah') }}" class="btn btn-sm btn-primary float-right" <?php if
                            ...
                            <button class="btn btn-info btn-sm float-right mr-1 lihat-riwayat"
                                data-riwayat-table="hutangdetail"><i class="fa fa-history mr-1"></i> Lihat
                                Riwayat</button>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <select name="statuslunas" id="statuslunas" class="form-control select2">
                                    ...
                                    <table class="table table-bordered text-sm" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="width: 15%; text-align: center;">ID Utang/<br>Tanggal</th>
                                                <th style="width: 15%; text-align: center;">No Faktur</th>
                                                <th style="text-align: left;">Nama Supplier</th>
                                                <th style="width: 10%; text-align: right;">Jumlah Utang</th>
