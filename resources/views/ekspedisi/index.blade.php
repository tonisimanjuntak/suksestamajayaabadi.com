                        ...
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Ekspedisi</h3>
                                <a href="{{ url('ekspedisi/tambah') }}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <table class="table table-bordered" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="width: 15%; text-align: center;">ID Ekspedisi</th>
                                                <th style="text-align: left;">Nama Ekspedisi</th>
