...
<body>
    ...
    <div class="judullaporan">
        <div class="nama-laporan">LAPORAN PENERIMAAN</div>
        ...
        <table border="1" cellpadding="2" width="100%">
            <thead>
                <tr style="font-size: 10px; font-weight: bold;">
                    ...
                    <th width="15%" style="text-align:center;">ID PENERIMAAN</th>
                    ...
                    <th width="15%" style="text-align:center;">JLH PENERIMAAN</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                @else
                    ...
                    @foreach ($rsPenerimaan as $row)
                        @php
                            $total += $row->totalpenerimaan;
                        @endphp

                        <tr style="font-size: 9px;">
                            <td width="5%" style="text-align:center;">{{ $no++ }}</td>
                            <td width="15%" style="text-align:center;">{{ $row->idpenerimaan }} </td>
                            <td width="15%" style="text-align:center;">{{ tglindonesia($row->tglpenerimaan) }}</td>
                            ...
                            <td width="15%" style="text-align:right;">
                                {{ format_rupiah($row->totalpenerimaan) }}</td>
                        </tr>
                    @endforeach
