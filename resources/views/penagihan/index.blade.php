            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Penagihan Piutang</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Penagihan Piutang</h3>
                                <a href="{{ url('penagihan/tambah') }}" class="btn btn-sm btn-primary"><i
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="row">
                                        <div class="col-12">
                                            <label for="">Tanggal Penagihan</label>
                                        </div>
                                        <div class="col-md-12">
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tableList').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('penagihan.listdata') }}",
                type: 'GET',
                data: function(d) {
                    d.tglawal = $('#tglawal').val();
                    d.tglakhir = $('#tglakhir').val();
                    d.idsales = $('#idsales').val();
                }
            },
