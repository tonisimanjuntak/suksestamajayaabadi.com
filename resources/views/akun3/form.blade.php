...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Akun Lv. 3</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="{{ url('akun3') }}">Akun Lv. 3</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ url('akun3/simpanData') }}" method="POST" id="form"
                        enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-header">
                                <div class="d-flex justify-content-between">
                                    <h4 class="card-title font-weight-bold"><i class="fab fa-wpforms mr-1"></i><span
                                            class="label-judul"></span> Data Akun Lv. 3</h4>
                                </div>
                            </div>
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ url('akun3') }}" class="btn btn-default float-right mr-1"><i
...
<script>
    ...
    $(document).ready(function() {
                ...
                fields: {
                    kdakun: {
                        validators: {
                            ...
                            stringLength: {
                                min: 4, // Minimal 5 karakter
                                max: 4, // Maksimal 10 karakter
                                message: 'Kode akun harus 4 karakter'
                            }
                        }
                    },
                    namaakun: {
        ...
        $('#kdparent').select2({
            ...
            ajax: {
                url: "{{ route('akun3.searchParentAkun') }}", // URL untuk pencarian
                dataType: 'json',
