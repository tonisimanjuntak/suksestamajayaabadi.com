...
<body>
    ...
    <div class="judullaporan">
        <div class="nama-laporan">STOK OPNAME</div>
        <div class="periode-laporan">TANGGAL: {{ tgldatetime($rsSO->tglstockopname) }}</div>
    </div>
        ...
        <table border="1" cellpadding="10" width="100%">
            ...
            <tbody>
                ...
                <tr style="font-size: 9px;">
                    ...
                    <td style="width: 15%; text-align: right;">{{ $p->stockopname}}</td>
                </tr>
