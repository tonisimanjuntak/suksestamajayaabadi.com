...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Detail Penjualan</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <div class="card">
                                        <div class="card-body p-5">
                                            <div class="row">
                                                ...
                                                <div class="col-12 mb-5 text-lg font-weight-bold">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="optOrderBy"
                                                            id="optOrderBy1" value="bysales" checked>
                                                        <label class="form-check-label" for="optOrderBy1">Order By
                                                            Sales</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="optOrderBy"
                                                            id="optOrderBy2" value="bytgl">
                                                        <label class="form-check-label" for="optOrderBy2">Order By Tgl
                                                            Penjualan</label>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="idpenjualan" class="col-md-3 col-form-label">Nomor
                                                            Invoice</label>
                                                        <div class="col-md-9">
...
<script>
    $(document).ready(function () {
        ...
        {
            if ($('#optOrderBy1').prop('checked')) {
                var orderBy = $('#optOrderBy1').val();                
            }else{
                var orderBy = $('#optOrderBy2').val();
            }
