    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Laporan Buku Utang</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ url('/') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Laporan Buku Utang</li>
                        </ol>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        function cetak(jenisCetakan) {
            ...
            window.open("{{ url('lapbukuhutang/cetak') }}/" + jenisCetakan + "?" + params.toString());
