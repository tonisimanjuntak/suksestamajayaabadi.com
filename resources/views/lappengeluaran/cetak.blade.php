...
<body>
    ...
    <div class="judullaporan">
        <div class="nama-laporan">LAPORAN PENGELUARAN</div>
        ...
        <table border="1" cellpadding="2" width="100%">
            <thead>
                <tr style="font-size: 10px; font-weight: bold;">
                    ...
                    <th width="15%" style="text-align:center;">ID PENGELUARAN</th>
                    <th width="15%" style="text-align:center;">TANGGAL/<br>NO KWITANSI</th>
                    <th width="35%" style="text-align:center;">KETERANGAN</th>
                    <th width="15%" style="text-align:center;">CARA<br>BAYAR</th>
                    <th width="15%" style="text-align:center;">JLH PENGELUARAN</th>
                </tr>
            </thead>
            <tbody>
                @php
                ...
                @else
                    ...
                    @foreach ($rsPengeluaran as $row)
                        @php
                            $total += $row->totalpengeluaran;
                        @endphp

                        <tr style="font-size: 9px;">
                            <td width="5%" style="text-align:center;">{{ $no++ }}</td>
                            <td width="15%" style="text-align:center;">{{ $row->idpengeluaran }} </td>
                            <td width="15%" style="text-align:center;">{{ tglindonesia($row->tglpengeluaran) }} <br> {{ $row->nokwitansi }}</td>
                            <td width="35%" style="text-align:left;">{{ $row->keterangan }}</td>
                            ...
                            <td width="15%" style="text-align:right;">
                                {{ format_rupiah($row->totalpengeluaran) }}</td>
                        </tr>
                    @endforeach
                    
                    <tr style="font-size: 10px; font-weight: bold;">
                        <td width="85%" style="text-align:right;" colspan="7">TOTAL</td>
                        <td width="15%" style="text-align:right;">
