                        ...
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Satuan Barang</h3>
                                <a href="{{ url('satuan/tambah') }}" class="btn btn-sm btn-primary" @php if
                                    (!str_contains(strtolower(session('hakaksi_aktif')), 'tambah' )) {
                                    echo 'style="display: none;"' ; } @endphp><i class="fa fa-plus-circle mr-1"></i>
                                    Tambah Data</a>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="text-align: left;">Satuan Barang</th>
