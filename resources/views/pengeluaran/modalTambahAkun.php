    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Detail Pengeluaran</h5>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="{{ url('pengeluaran/simpanData') }}" method="post" id="formModalTambahDetail" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <select name="kdakun" id="kdakun" class="form-control searchAkunPengeluaran"></select>
                                        ...
                                        <div class="form-group row">
                                            <label for="jumlahpengeluaran" class="col-md-3 col-form-label">Jumlah Pengeluaran</label>
                                            <div class="col-md-4">
    ...
    $(document).ready(function() {
        $('#formModalTambahDetail').bootstrapValidator({
            ...
            .on('success.form.bv', function(e) {
                ...
                var jumlahpengeluaran = untitik($('#jumlahpengeluaran').val());

                addTableRow(kdakun, namaakun, jumlahpengeluaran);
                $('#tambahkan').attr('disabled', false);
            });
    });


    function addTableRow(kdakun, namaakun, jumlahpengeluaran) {
        ...
        var totalSemua = parseInt(jumlahpengeluaran);
        ...
        var addText = `<tr>
                                ...
                                <td style="text-align: right;">` + numberWithCommas(jumlahpengeluaran) + `</td>
