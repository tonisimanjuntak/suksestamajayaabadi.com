                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title font-weight-bold"><i class="fab fa-wpforms mr-1"></i><span
                                        class="label-judul"></span> Data Pengeluaran</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 required">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="nokwitansi" id="nokwitansi"
                                                            class="form-control" placeholder="Nomor kwitansi">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 required" id="divBank" style="display:none;">
                                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <h3 class="text-muted">Detail Pengeluaran</h3>
                                                </div>
                                                <div class="col-md-4">
                                                        ...
                                                        <table id="tableDetail" class="table" style="width: 100%;">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 15%; text-align: right;">Jumlah Pengeluaran</th>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ url('pengeluaran') }}" class="btn btn-default float-right mr-1"><i
...
@include('pengeluaran/modalTambahAkun')
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        if (idpengeluaran != "") {
            $('#idpengeluaran').val(idpengeluaran);
            $('.label-judul').html('Edit');
            $.ajax({
                    url: "{{ url('pengeluaran/getDataID') }}",
                    type: 'GET',
                    dataType: 'json',
                    data: {
                ...
                .done(function(response) {
                    ...
                    var rsPengeluaran = response.rsPengeluaran;
                    $('#nokwitansi').val(rsPengeluaran['nokwitansi']);
                    $('#tglpengeluaran').val(rsPengeluaran['tglpengeluaran']);
                    $('#keterangan').val(rsPengeluaran['keterangan']);
                    $('#carabayar').val(rsPengeluaran['carabayar']).trigger('change');

                    if (rsPengeluaran['idbank'] != '') {
                        addSelectOption('idbank', rsPengeluaran['idbank'], rsPengeluaran['namabank'])
                        $('#idbank').val(rsPengeluaran['idbank']);
                    }
                    ...
                    if (rsDetail.length > 0) {
                        for (var i = 0; i < rsDetail.length; i++) {
                            ...
                            addTableRow(rsDetail[i]['kdakun'], rsDetail[i]['namaakun'], rsDetail[i]['jumlahpengeluaran'])
                        }
                    }
                })
                .fail(function() {
    ...
    $('#simpan').click(function() {
        ...
        if (nokwitansi == '') {
            swal("Informasi", "Nomor kwitansi tidak boleh kosong!", "info")
                .then(function() {
                    $('#nokwitansi').focus();
                });
            return;
        ...
        $.ajax({
                type: 'POST',
                url: "{{ url('pengeluaran/simpanData') }}",
