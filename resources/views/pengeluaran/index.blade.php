                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Pengeluaran</h3>
                                <a href="{{ url('pengeluaran/tambah') }}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <table class="table table-bordered text-sm" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="width: 15%; text-align: center;">ID Pengeluaran</th>
                                                <th style="width: 15%; text-align: center;">Tanggal</th>
                                                <th style="text-align: left;">No Kwitansi</th>
                                                <th style="text-align: left;">Keterangan</th>
                                                <th style="text-align: center;">Cara Bayar</th>
                                                <th style="width: 10%; text-align: right;">Total Pengeluaran</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tableList').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('pengeluaran.listdata') }}",
                type: 'GET',
                data: function(d) {
