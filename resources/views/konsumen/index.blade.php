                        ...
                        <div class="card-header border-0">
                            <div class="d-flex justify-content-between">
                                <h3 class="card-title font-weight-bold"><i class="far fa-list-alt mr-1"></i>List Data
                                    Konsumen</h3>
                                <a href="{{ url('konsumen/tambah') }}" class="btn btn-sm btn-primary"><i
                                    ...
                                    <table class="table table-bordered text-sm" id="tableList">
                                        <thead class="">
                                            <tr>
                                                ...
                                                <th style="width: 15%; text-align: center;">ID Konsumen</th>
                                                <th style="text-align: center;">Nama Konsumen</th>
                                                <th style="text-align: center;">Informasi Pemilik</th>
